...
Spring Boot/JPA/Maven Wrapper, PostgreSQL em Compose, React/TypeScript/Vite/Material UI gratuito. Versões compatíveis serão verificadas antes do setup. README, SPEC de 1 a 2 páginas, DECISIONS, ER e OpenAPI. REVIEW deve analisar o Anexo A por severidade, impacto e correção. AI_USAGE deve incluir prompts estratégicos, erro real/processo de detecção e o que não foi delegado. Histórico Git e defesa explicáveis. Prazo: 18/09, horário a confirmar no e-mail.
